#ifndef JL_FUNCTION_COPY_ONLY
#define JL_FUNCTION_COPY_ONLY
#include <array>
#include <cstddef>
#include <memory>
#include <stdexcept>
...
namespace jl::copy_only {
    ...
    public:
        ...
        template<concepts::copy_only_callable<R, Args...> Impl>
